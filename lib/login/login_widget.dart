...
class _LoginWidgetState extends State<LoginWidget>
  ...
  void initState() {
    ...
    _model.loginEmaiAddressTextController ??= TextEditingController();
    _model.loginEmaiAddressFocusNode ??= FocusNode();
                ...
                child: Column(
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/Screenshot_from_2025-02-07_13-32-01.png',
                        width: 120.0,
                        fit: BoxFit.contain,
                      ),
                    ),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              .loginEmaiAddressTextController,
                                          focusNode:
                                              _model.loginEmaiAddressFocusNode,
                                          onChanged: (_) =>
                                              EasyDebounce.debounce(
                                            '_model.loginEmaiAddressTextController',
                                            Duration(milliseconds: 2000),
                                            () => safeSetState(() {}),
                                          ),
                                          autofocus: false,
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              final user = await authManager.signInWithEmail(
                                context,
                                _model.loginEmaiAddressTextController.text,
                              ...
                              context.pushNamedAuth('tasks', context.mounted);
                            },
                            text: 'Log In',
